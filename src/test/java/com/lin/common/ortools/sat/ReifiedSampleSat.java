...
/**
 * Reification is the action of associating a Boolean variable to a constraint. This boolean enforces or prohibits the
 * constraint according to the value the Boolean variable is fixed to.
 *
 * <p>
 * Half-reification is defined as a simple implication: If the Boolean variable is true, then the constraint holds,
 * instead of an complete equivalence.
 *
 * <p>
