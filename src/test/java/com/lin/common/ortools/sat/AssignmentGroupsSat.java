...
public class AssignmentGroupsSat {
    public static void main(String[] args) {
        ...
        // Data
        // [START data]
        int[][] costs = {{90, 76, 75, 70, 50, 74}, {35, 85, 55, 65, 48, 101}, {125, 95, 90, 105, 59, 120},
        ...
        int[][] group1 = {{0, 0, 1, 1}, // Workers 2, 3
            {0, 1, 0, 1}, // Workers 1, 3
            {0, 1, 1, 0}, // Workers 1, 2
            {1, 1, 0, 0}, // Workers 0, 1
            {1, 0, 1, 0}, // Workers 0, 2
        ...
        int[][] group2 = {{0, 0, 1, 1}, // Workers 6, 7
            {0, 1, 0, 1}, // Workers 5, 7
            {0, 1, 1, 0}, // Workers 5, 6
            {1, 1, 0, 0}, // Workers 4, 5
            {1, 0, 0, 1}, // Workers 4, 7
        ...
        int[][] group3 = {{0, 0, 1, 1}, // Workers 10, 11
