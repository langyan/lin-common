...
public class Tsp {
    ...
    static class DataModel {
        public final int[][] locations = {{4, 4}, {2, 0}, {8, 0}, {0, 1}, {1, 1}, {5, 2}, {7, 2}, {3, 3}, {6, 3},
    ...
    public static void main(String[] args) throws Exception {
        ...
        final int transitCallbackIndex = routing.registerTransitCallback(new ManhattanDistance(data, manager));
