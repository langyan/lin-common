...
public final class VrpSolutionCallback {
    ...
    static class SolutionCallback implements Runnable {
        ...
        public SolutionCallback(final RoutingIndexManager manager, final RoutingModel routing, int limit) {
    ...
    public static void main(String[] args) {
        ...
        final int transitCallbackIndex = routingModel.registerTransitCallback((long fromIndex, long toIndex) -> {
        ...
        routingModel.addDimension(transitCallbackIndex, 0, // no slack
