...
public final class VrpWithTimeLimit {
    ...
    public static void main(String[] args) {
        ...
        final int transitCallbackIndex = routing.registerTransitCallback((long fromIndex, long toIndex) -> 1);
        ...
        routing.addDimension(transitCallbackIndex, /*slack_max=*/0, /*capacity=*/3000, /*fix_start_cumul_to_zero=*/true,
            "Distance");
        ...
        RoutingSearchParameters searchParameters = main.defaultRoutingSearchParameters().toBuilder()
            ...
            .setLocalSearchMetaheuristic(LocalSearchMetaheuristic.Value.GUIDED_LOCAL_SEARCH).setLogSearch(true)
            .setTimeLimit(Duration.newBuilder().setSeconds(5).build()).build();
        // [END parameters]
