...
public class VrpPickupDeliveryLifo {
    ...
    public static void main(String[] args) throws Exception {
        ...
        for (int[] request : data.pickupsDeliveries) {
            ...
            solver
                .addConstraint(solver.makeEquality(routing.vehicleVar(pickupIndex), routing.vehicleVar(deliveryIndex)));
        ...
        RoutingSearchParameters searchParameters = main.defaultRoutingSearchParameters().toBuilder()
            .setFirstSolutionStrategy(FirstSolutionStrategy.Value.PARALLEL_CHEAPEST_INSERTION).build();
        // [END parameters]
