...
public final class VrpBreaks {
    ...
    static class DataModel {
        public final long[][] timeMatrix = {{0, 27, 38, 34, 29, 13, 25, 9, 15, 9, 26, 25, 19, 17, 23, 38, 33},
        ...
        public final long[] serviceTime = {0, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15,};
    ...
    public static void main(String[] args) {
        ...
        routing.addDimension(transitCallbackIndex, 10, 180, true, // start cumul to zero
            "Time");
        RoutingDimension timeDimension = routing.getMutableDimension("Time");
