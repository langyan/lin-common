...
public class MinimalJobshopSat {
    public static void main(String[] args) {
        ...
        final List<List<Task>> allJobs = Arrays.asList(Arrays.asList(new Task(0, 3), new Task(1, 2), new Task(2, 2)), // Job0
        ...
        for (int jobID = 0; jobID < allJobs.size(); ++jobID) {
            ...
            for (int taskID = 0; taskID < job.size(); ++taskID) {
                ...
                taskType.interval = model.newIntervalVar(taskType.start, LinearExpr.constant(task.duration),
                    taskType.end, "interval" + suffix);
            ...
            for (int jobID = 0; jobID < allJobs.size(); ++jobID) {
                ...
                for (int taskID = 0; taskID < job.size(); ++taskID) {
                    ...
                    AssignedTask assignedTask =
                        new AssignedTask(jobID, taskID, (int)solver.value(allTasks.get(key).start), task.duration);
